...
import SocialFiModal from '@components/common/SocialFiModal';
    ...
    <div className="rpc-status-box">
      <div className="rpc-status-content">
        <div className="project-info">
          ...
          <span className="project-name">PermaBrawl by AO</span>
          <FiRefreshCcw
            size={20}
      ...
      {/* Modal */}
      <SocialFiModal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)} />
    </div>
  );
};
