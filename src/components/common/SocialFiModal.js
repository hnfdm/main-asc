...
const SocialFiModal = ({ isOpen, onRequestClose }) => {
  const socialfi = [
    { name: 'Permabrawl', image: '/blog/ao.png', date: "2025-02-16", link: '/blog/permabrawl' },
    { name: 'Kaito AI', image: '/blog/kaito.jpg', date: "2025-02-10", link: '/blog/kaito' },
  ...
  return (
    ...
    >
      <h2 className="blog-title">Social Fi</h2>
