...
import '@styles/node/autonomys/RpcStatusBox.css'; // 
    ...
    <div className="rpc-status-box">
      <div className="rpc-status-content">
        <div className="project-info">
          <span className="project-name">Autonomys</span>
          <FiRefreshCcw
            size={20}
        ...
        <div className="chain-info"><strong>Chain ID :</strong> -</div>
        ...
        <div className="explorer-link">
          <a href="https://dillscan.dill.xyz/" target="_blank" rel="noopener noreferrer">Explorer</a>
        </div>
      </div>
