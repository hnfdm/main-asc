...
import '@styles/node/fiamma/RpcStatusBox.css'; // 
...
const RpcStatusBox = () => {
  ...
  useEffect(() => {
    const fetchBlockHeight = async () => {
      try {
        const response = await fetch('https://rpc-fiamma.bangpateng.xyz/status');
    ...
    <div className="rpc-status-box">
      <div className="rpc-status-content">
        <div className="project-info">
          <span className="project-name">Fiamma</span>
          <FiRefreshCcw
            size={20}
        ...
        <div className="chain-info"><strong>Chain ID :</strong> fiamma-testnet-1</div>
        ...
        <div className="explorer-link">
          <a href="https://explorer.bangpateng.xyz/fiamma" target="_blank" rel="noopener noreferrer">Explorer</a>
        </div>
      </div>
