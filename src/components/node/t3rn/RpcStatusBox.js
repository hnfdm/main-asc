...
import '@styles/node/t3rn/RpcStatusBox.css'; // 
    ...
    <div className="rpc-status-box">
      <div className="rpc-status-content">
        <div className="project-info">
          <span className="project-name">T3rn</span>
          <FiRefreshCcw
            size={20}
        ...
        <div className="explorer-link">
          <a href="https://brn.explorer.caldera.xyz/" target="_blank" rel="noopener noreferrer">Explorer</a>
        </div>
      </div>
